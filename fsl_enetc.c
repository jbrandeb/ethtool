...
#define ENETC_PM0_CMD_TX_EN		_BITUL(0)
#define ENETC_PM0_CMD_RX_EN		_BITUL(1)
#define ENETC_PM0_CMD_WAN		_BITUL(3)
#define ENETC_PM0_CMD_PROMISC		_BITUL(4)
#define ENETC_PM0_CMD_PAD		_BITUL(5)
#define ENETC_PM0_CMD_CRC		_BITUL(6)
#define ENETC_PM0_CMD_PAUSE_FWD		_BITUL(7)
#define ENETC_PM0_CMD_PAUSE_IGN		_BITUL(8)
#define ENETC_PM0_CMD_TX_ADDR_INS	_BITUL(9)
#define ENETC_PM0_CMD_XGLP		_BITUL(10)
#define ENETC_PM0_CMD_TXP		_BITUL(11)
#define ENETC_PM0_CMD_SWR		_BITUL(12)
#define ENETC_PM0_CMD_CNT_FRM_EN	_BITUL(13)
#define ENETC_PM0_CMD_SEND_IDLE		_BITUL(16)
#define ENETC_PM0_CMD_NO_LEN_CHK	_BITUL(17)
#define ENETC_PM0_CMD_SFD		_BITUL(21)
#define ENETC_PM0_CMD_TX_LOWP_ENA	_BITUL(23)
#define ENETC_PM0_CMD_REG_LOWP_RXETY	_BITUL(24)
#define ENETC_PM0_CMD_RXSTP		_BITUL(29)
#define ENETC_PM0_CMD_MG		_BITUL(31)
