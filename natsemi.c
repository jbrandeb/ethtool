...
#define REG_CR				0
#define   BIT_CR_TXE			_BITUL(0)
#define   BIT_CR_RXE			_BITUL(2)
#define   BIT_CR_RST			_BITUL(8)
#define REG_CFG				1
#define   BIT_CFG_BEM			_BITUL(0)
#define   BIT_CFG_BROM_DIS		_BITUL(2)
#define   BIT_CFG_PHY_DIS		_BITUL(9)
#define   BIT_CFG_PHY_RST		_BITUL(10)
#define   BIT_CFG_EXT_PHY		_BITUL(12)
#define   BIT_CFG_ANEG_EN		_BITUL(13)
#define   BIT_CFG_ANEG_100		_BITUL(14)
#define   BIT_CFG_ANEG_FDUP		_BITUL(15)
#define   BIT_CFG_PINT_ACEN		_BITUL(17)
#define   BIT_CFG_PHY_CFG		(0x3f<<18)
#define   BIT_CFG_ANEG_DN		_BITUL(27)
#define   BIT_CFG_POL			_BITUL(28)
#define   BIT_CFG_FDUP			_BITUL(29)
#define   BIT_CFG_SPEED100		_BITUL(30)
#define   BIT_CFG_LNKSTS		_BITUL(31)

#define REG_MEAR			2
#define REG_PTSCR			3
#define   BIT_PTSCR_EEBIST_FAIL		_BITUL(0)
#define   BIT_PTSCR_EELOAD_EN		_BITUL(2)
#define   BIT_PTSCR_RBIST_RXFFAIL	_BITUL(3)
#define   BIT_PTSCR_RBIST_TXFAIL	_BITUL(4)
#define   BIT_PTSCR_RBIST_RXFAIL	_BITUL(5)
#define REG_ISR				4
#define REG_IMR				5
#define   BIT_INTR_RXOK			_BITUL(0)
#define   NAME_INTR_RXOK		"Rx Complete"
#define   BIT_INTR_RXDESC		_BITUL(1)
#define   NAME_INTR_RXDESC		"Rx Descriptor"
#define   BIT_INTR_RXERR		_BITUL(2)
#define   NAME_INTR_RXERR		"Rx Packet Error"
#define   BIT_INTR_RXEARLY		_BITUL(3)
#define   NAME_INTR_RXEARLY		"Rx Early Threshold"
#define   BIT_INTR_RXIDLE		_BITUL(4)
#define   NAME_INTR_RXIDLE		"Rx Idle"
#define   BIT_INTR_RXORN		_BITUL(5)
#define   NAME_INTR_RXORN		"Rx Overrun"
#define   BIT_INTR_TXOK			_BITUL(6)
#define   NAME_INTR_TXOK		"Tx Packet OK"
#define   BIT_INTR_TXDESC		_BITUL(7)
#define   NAME_INTR_TXDESC		"Tx Descriptor"
#define   BIT_INTR_TXERR		_BITUL(8)
#define   NAME_INTR_TXERR		"Tx Packet Error"
#define   BIT_INTR_TXIDLE		_BITUL(9)
#define   NAME_INTR_TXIDLE		"Tx Idle"
#define   BIT_INTR_TXURN		_BITUL(10)
#define   NAME_INTR_TXURN		"Tx Underrun"
#define   BIT_INTR_MIB			_BITUL(11)
#define   NAME_INTR_MIB			"MIB Service"
#define   BIT_INTR_SWI			_BITUL(12)
#define   NAME_INTR_SWI			"Software"
#define   BIT_INTR_PME			_BITUL(13)
#define   NAME_INTR_PME			"Power Management Event"
#define   BIT_INTR_PHY			_BITUL(14)
#define   NAME_INTR_PHY			"Phy"
#define   BIT_INTR_HIBERR		_BITUL(15)
#define   NAME_INTR_HIBERR		"High Bits Error"
#define   BIT_INTR_RXSOVR		_BITUL(16)
#define   NAME_INTR_RXSOVR		"Rx Status FIFO Overrun"
#define   BIT_INTR_RTABT		_BITUL(20)
#define   NAME_INTR_RTABT		"Received Target Abort"
#define   BIT_INTR_RMABT		_BITUL(20)
#define   NAME_INTR_RMABT		"Received Master Abort"
#define   BIT_INTR_SSERR		_BITUL(20)
#define   NAME_INTR_SSERR		"Signaled System Error"
#define   BIT_INTR_DPERR		_BITUL(20)
#define   NAME_INTR_DPERR		"Detected Parity Error"
#define   BIT_INTR_RXRCMP		_BITUL(20)
#define   NAME_INTR_RXRCMP		"Rx Reset Complete"
#define   BIT_INTR_TXRCMP		_BITUL(20)
#define   NAME_INTR_TXRCMP		"Tx Reset Complete"
#define REG_IER				6
#define   BIT_IER_IE			_BITUL(0)
#define REG_TXDP			8
#define REG_TXCFG			9
#define   BIT_TXCFG_DRTH		(0x3f<<0)
#define   BIT_TXCFG_FLTH		(0x3f<<8)
#define   BIT_TXCFG_MXDMA		(0x7<<20)
#define   BIT_TXCFG_ATP			_BITUL(28)
#define   BIT_TXCFG_MLB			_BITUL(29)
#define   BIT_TXCFG_HBI			_BITUL(30)
#define   BIT_TXCFG_CSI			_BITUL(31)
#define REG_RXDP			12
#define REG_RXCFG			13
#define   BIT_RXCFG_DRTH		(0x1f<<1)
#define   BIT_RXCFG_MXDMA		(0x7<<20)
#define   BIT_RXCFG_ALP			_BITUL(27)
#define   BIT_RXCFG_ATX			_BITUL(28)
#define   BIT_RXCFG_ARP			_BITUL(30)
#define   BIT_RXCFG_AEP			_BITUL(31)
#define REG_CCSR			15
#define   BIT_CCSR_CLKRUN_EN		_BITUL(0)
#define   BIT_CCSR_PMEEN		_BITUL(8)
#define   BIT_CCSR_PMESTS		_BITUL(15)
#define REG_WCSR			16
#define   BIT_WCSR_WKPHY		_BITUL(0)
#define   BIT_WCSR_WKUCP		_BITUL(1)
#define   BIT_WCSR_WKMCP		_BITUL(2)
#define   BIT_WCSR_WKBCP		_BITUL(3)
#define   BIT_WCSR_WKARP		_BITUL(4)
#define   BIT_WCSR_WKPAT0		_BITUL(5)
#define   BIT_WCSR_WKPAT1		_BITUL(6)
#define   BIT_WCSR_WKPAT2		_BITUL(7)
#define   BIT_WCSR_WKPAT3		_BITUL(8)
#define   BIT_WCSR_WKMAG		_BITUL(9)
#define   BIT_WCSR_MPSOE		_BITUL(10)
#define   BIT_WCSR_SOHACK		_BITUL(20)
#define   BIT_WCSR_PHYINT		_BITUL(22)
#define   BIT_WCSR_UCASTR		_BITUL(23)
#define   BIT_WCSR_MCASTR		_BITUL(24)
#define   BIT_WCSR_BCASTR		_BITUL(25)
#define   BIT_WCSR_ARPR			_BITUL(26)
#define   BIT_WCSR_PATM0		_BITUL(27)
#define   BIT_WCSR_PATM1		_BITUL(28)
#define   BIT_WCSR_PATM2		_BITUL(29)
#define   BIT_WCSR_PATM3		_BITUL(30)
#define   BIT_WCSR_MPR			_BITUL(31)
#define REG_PCR				17
#define   BIT_PCR_PAUSE_CNT		(0xffff<<0)
#define   BIT_PCR_PSNEG			_BITUL(21)
#define   BIT_PCR_PS_RCVD		_BITUL(22)
#define   BIT_PCR_PS_DA			_BITUL(29)
#define   BIT_PCR_PSMCAST		_BITUL(30)
#define   BIT_PCR_PSEN			_BITUL(31)
#define REG_RFCR			18
#define   BIT_RFCR_UHEN			_BITUL(20)
#define   BIT_RFCR_MHEN			_BITUL(21)
#define   BIT_RFCR_AARP			_BITUL(22)
#define   BIT_RFCR_APAT0		_BITUL(23)
#define   BIT_RFCR_APAT1		_BITUL(24)
#define   BIT_RFCR_APAT2		_BITUL(25)
#define   BIT_RFCR_APAT3		_BITUL(26)
#define   BIT_RFCR_APM			_BITUL(27)
#define   BIT_RFCR_AAU			_BITUL(28)
#define   BIT_RFCR_AAM			_BITUL(29)
#define   BIT_RFCR_AAB			_BITUL(30)
#define   BIT_RFCR_RFEN			_BITUL(31)
#define REG_RFDR			19
#define REG_BRAR			20
#define   BIT_BRAR_AUTOINC		_BITUL(31)
#define REG_BRDR			21
#define REG_SRR				22
#define REG_MIBC			23
#define   BIT_MIBC_WRN			_BITUL(0)
#define   BIT_MIBC_FRZ			_BITUL(1)
#define REG_MIB0			24
#define REG_MIB1			25
#define REG_MIB2			26
#define REG_MIB3			27
...
#define REG_MIB6			30
#define REG_BMCR			32
#define   BIT_BMCR_FDUP			_BITUL(8)
#define   BIT_BMCR_ANRST		_BITUL(9)
#define   BIT_BMCR_ISOL			_BITUL(10)
#define   BIT_BMCR_PDOWN		_BITUL(11)
#define   BIT_BMCR_ANEN			_BITUL(12)
#define   BIT_BMCR_SPEED		_BITUL(13)
#define   BIT_BMCR_LOOP			_BITUL(14)
#define   BIT_BMCR_RST			_BITUL(15)
#define REG_BMSR			33
#define   BIT_BMSR_JABBER		_BITUL(1)
#define   BIT_BMSR_LNK			_BITUL(2)
#define   BIT_BMSR_ANCAP		_BITUL(3)
#define   BIT_BMSR_RFAULT		_BITUL(4)
#define   BIT_BMSR_ANDONE		_BITUL(5)
#define   BIT_BMSR_PREAMBLE		_BITUL(6)
#define   BIT_BMSR_10HCAP		_BITUL(11)
#define   BIT_BMSR_10FCAP		_BITUL(12)
#define   BIT_BMSR_100HCAP		_BITUL(13)
#define   BIT_BMSR_100FCAP		_BITUL(14)
#define   BIT_BMSR_100T4CAP		_BITUL(15)
...
#define   BIT_ANAR_10			_BITUL(5)
#define   BIT_ANAR_10_FD		_BITUL(6)
#define   BIT_ANAR_TX			_BITUL(7)
#define   BIT_ANAR_TXFD			_BITUL(8)
#define   BIT_ANAR_T4			_BITUL(9)
#define   BIT_ANAR_PAUSE		_BITUL(10)
#define   BIT_ANAR_RF			_BITUL(13)
#define   BIT_ANAR_NP			_BITUL(15)
#define REG_ANLPAR			37
#define   BIT_ANLPAR_PROTO		(0x1f<<0)
#define   BIT_ANLPAR_10			_BITUL(5)
#define   BIT_ANLPAR_10_FD		_BITUL(6)
#define   BIT_ANLPAR_TX			_BITUL(7)
#define   BIT_ANLPAR_TXFD		_BITUL(8)
#define   BIT_ANLPAR_T4			_BITUL(9)
#define   BIT_ANLPAR_PAUSE		_BITUL(10)
#define   BIT_ANLPAR_RF			_BITUL(13)
#define   BIT_ANLPAR_ACK		_BITUL(14)
#define   BIT_ANLPAR_NP			_BITUL(15)
#define REG_ANER			38
#define   BIT_ANER_LP_AN_ENABLE		_BITUL(0)
#define   BIT_ANER_PAGE_RX		_BITUL(1)
#define   BIT_ANER_NP_ABLE		_BITUL(2)
#define   BIT_ANER_LP_NP_ABLE		_BITUL(3)
#define   BIT_ANER_PDF			_BITUL(4)
#define REG_ANNPTR			39
#define REG_PHYSTS			48
#define   BIT_PHYSTS_LNK		_BITUL(0)
#define   BIT_PHYSTS_SPD10		_BITUL(1)
#define   BIT_PHYSTS_FDUP		_BITUL(2)
#define   BIT_PHYSTS_LOOP		_BITUL(3)
#define   BIT_PHYSTS_ANDONE		_BITUL(4)
#define   BIT_PHYSTS_JABBER		_BITUL(5)
#define   BIT_PHYSTS_RF			_BITUL(6)
#define   BIT_PHYSTS_MINT		_BITUL(7)
#define   BIT_PHYSTS_FC			_BITUL(11)
#define   BIT_PHYSTS_POL		_BITUL(12)
#define   BIT_PHYSTS_RXERR		_BITUL(13)
#define REG_MICR			49
#define   BIT_MICR_INTEN		_BITUL(1)
#define REG_MISR			50
#define   BIT_MISR_MSK_RHF		_BITUL(9)
#define   BIT_MISR_MSK_FHF		_BITUL(10)
#define   BIT_MISR_MSK_ANC		_BITUL(11)
#define   BIT_MISR_MSK_RF		_BITUL(12)
#define   BIT_MISR_MSK_JAB		_BITUL(13)
#define   BIT_MISR_MSK_LNK		_BITUL(14)
#define   BIT_MISR_MINT			_BITUL(15)
#define REG_PGSEL			51
#define REG_FCSCR			52
#define REG_RECR			53
#define REG_PCSR			54
#define   BIT_PCSR_NRZI			_BITUL(2)
#define   BIT_PCSR_FORCE_100		_BITUL(5)
#define   BIT_PCSR_SDOPT		_BITUL(8)
#define   BIT_PCSR_SDFORCE		_BITUL(9)
#define   BIT_PCSR_TQM			_BITUL(10)
#define   BIT_PCSR_CLK			_BITUL(11)
#define   BIT_PCSR_4B5B			_BITUL(12)
#define REG_PHYCR			57
#define   BIT_PHYCR_PHYADDR		(0x1f<<0)
#define   BIT_PHYCR_PAUSE_STS		_BITUL(7)
#define   BIT_PHYCR_STRETCH		_BITUL(8)
#define   BIT_PHYCR_BIST		_BITUL(9)
#define   BIT_PHYCR_BIST_STAT		_BITUL(10)
#define   BIT_PHYCR_PSR15		_BITUL(11)
#define REG_TBTSCR			58
#define   BIT_TBTSCR_JAB		_BITUL(0)
#define   BIT_TBTSCR_BEAT		_BITUL(1)
#define   BIT_TBTSCR_AUTOPOL		_BITUL(3)
#define   BIT_TBTSCR_POL		_BITUL(4)
#define   BIT_TBTSCR_FPOL		_BITUL(5)
#define   BIT_TBTSCR_FORCE_10		_BITUL(6)
#define   BIT_TBTSCR_PULSE		_BITUL(7)
#define   BIT_TBTSCR_LOOP		_BITUL(8)
